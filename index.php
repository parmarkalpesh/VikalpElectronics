<?php include '../VikalpElectronics/include/header.php' ;?>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                ...
                                <p class="fs-5 text-white mb-4 pb-2">We provide high-quality CCTV camera services, including professional installation, maintenance, and monitoring to ensure your property is secure 24/7.</p>
                                <a href="../VikalpElectronics/quote.php" class="btn btn-light rounded-pill py-md-3 px-md-5 animated slideInRight">Free Quote</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                ...
                                <p class="fs-5 text-white mb-4 pb-2">Our skilled technicians offer seamless CCTV camera installation tailored to meet the security needs of your home or business.</p>
                                <a href="../VikalpElectronics/quote.php" class="btn btn-light rounded-pill py-md-3 px-md-5 animated slideInRight">Free Quote</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                ...
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">We offer routine maintenance services to keep your CCTV cameras functioning at their best, ensuring uninterrupted security coverage.</p>
                                <a href="../VikalpElectronics/quote.php" class="btn btn-light rounded-pill py-md-3 px-md-5 animated slideInRight">Free Quote</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="h-100 bg-dark p-4 p-xl-5">
                        ...
                        <hr class="w-25">
                        <span>Our advanced CCTV camera systems offer reliable home security, keeping your family and property safe around the clock.</span>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="h-100 bg-dark p-4 p-xl-5">
                        ...
                        <hr class="w-25">
                        <span>Control who enters and exits your facility with our reliable access control solutions, tailored to meet your specific security requirements.</span>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="h-100 bg-dark p-4 p-xl-5">
                        ...
                        <hr class="w-25">
                        <span>With our 24/7 surveillance and access control solutions, you can rest easy knowing your property is protected day and night.</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0 mx-lg-0">
                ...
                <div class="col-lg-6 about-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        ...
                        <p class="mb-4 pb-2">Vikalp Electronics has been a trusted name in Jamnagar for over 15 years, providing expert services in CCTV installation, maintenance, and security systems. Our long-standing presence in the market is a testament to our commitment to quality and customer satisfaction. With a strong focus on delivering reliable and cutting-edge security solutions, we ensure that our clients receive the best service to protect their homes and businesses. Whether it’s installing a new system or maintaining an existing one, Vikalp Electronics is dedicated to securing what matters most to you.</p>
            ...
            <div class="row g-0 service-row">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="service-item border h-100 p-5">
                        ...
                        <p class="mb-4">We provide top-tier Commercial CCTV System services, ensuring 24/7 security with expert installation and advanced surveillance features</p>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="service-item border h-100 p-5">
                        ...
                        <p class="mb-4">We offer secure Fingerprint Access services, providing efficient and reliable entry control with biometric technology.</p>
                        <!-- <a class="btn" href=""><i class="fa fa-arrow-right text-white me-3"></i>Read More</a> -->
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="service-item border h-100 p-5">
                        ...
                        <p class="mb-4">We provide comprehensive Fire Detection and Safety services to protect your property with advanced alarm systems and safety solutions.</p>
                        <!-- <a class="btn" href=""><i class="fa fa-arrow-right text-white me-3"></i>Read More</a> -->
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="service-item border h-100 p-5">
                        ...
                        <p class="mb-4">We offer Smart Home Security services that integrate advanced technology for seamless monitoring and control of your home’s safety.</p>
                        <!-- <a class="btn" href=""><i class="fa fa-arrow-right text-white me-3"></i>Read More</a> -->
                    </div>
                </div>
            </div>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 ps-lg-0">
                        ...
                        <p class="mb-4 pb-2">At Vikalp Electronics, we combine years of experience with a commitment to quality service, ensuring reliable and effective security solutions. Our team utilizes the latest technology to deliver state-of-the-art systems tailored to your needs. With 24/7 support and maintenance, we ensure your security systems operate smoothly. Our ability to customize services to meet your unique requirements makes us the ideal choice for protecting your home or business.</p>
                        <div class="row g-4">
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    <div class="btn-square bg-white rounded-circle" style="width: 64px; height: 64px;">
            ...
            <div class="row g-0 mx-lg-0">
                ...
                <div class="col-lg-6 quote-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        ...
                        <p class="mb-4 pb-2">Ready to enhance your security? Contact us today for a free quote on our CCTV, access control, fire detection, and smart home security services. Our team will assess your needs and provide a customized solution that fits your budget. Fill out the form below or call us directly to get started!</p>
                        <form>
                            <div class="row g-3">
...
<?php include '../VikalpElectronics/include/footer.php' ;?>